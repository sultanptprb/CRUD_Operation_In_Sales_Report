...
def membuat():                                                           
    ...
    if pilihanMembuat == '1':
        ...
        if POBaru in dataPembelian.keys():                                          # karena terdapat persyaratan yaitu untuk PO harus terdiri dari huruf capital
            ...
            NPBaru = input('masukan nama pembeli:')
            quantityBaru = int(input('masukan kuantitas pembelian:'))
            MPBaru = input('masukan metode pembayaran:')
...
def update():                                                                           
    ...
    if pilihanUpdate == '1':
        ...
        print(f'''
        Apakah anda ingin memperbarui data ini {dataPembelian[POUpdate]}?
        1. YA
        2. Tidak
        --------------------------------------------------------------------------------------------------
        ''')
        updateData = input('Masukan pilihan anda:')
        if updateData == '1':
